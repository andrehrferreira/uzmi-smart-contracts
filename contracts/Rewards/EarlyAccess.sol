...
contract EarlyAccess {
    ...
    function create(address _owner, uint256 _founderMedalId, uint256 _cardId) public onlyCreator {
        rewards[rewardsCounter] = Reward({
            owner: _owner,
            founderMedalId: _founderMedalId,
            cardId: _cardId,
            opened: false
        });
    ...
    function open(uint256 _id) public {
        ...
        nftContract.transferFrom(address(this), msg.sender, reward.cardId);
        nftContract.transferFrom(address(this), msg.sender, reward.founderMedalId);
